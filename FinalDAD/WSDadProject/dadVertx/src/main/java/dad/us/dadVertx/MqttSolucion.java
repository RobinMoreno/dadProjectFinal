...
public class MqttSolucion extends AbstractVerticle {
	...
	private static void init(MqttServer mqttServer) {
		mqttServer.endpointHandler(endpoint -> {
			...
			// el cliente para poder reenviar todos los mensajes que se publiquen en el topic al que
			// se ha suscrito.
	...
	private static void handleUnsubscription(MqttEndpoint endpoint) {
		endpoint.unsubscribeHandler(unsubscribe -> {
			for (String t : unsubscribe.topics()) {
				// Eliminamos al cliente de la lista de clientes suscritos al topic
